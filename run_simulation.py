...
# isolation_folder = os.path.join(current_folder, "Isolation")

# route_path = os.path.join(isolation_folder, "my_routes.rou.xml")
...
try:
    ...
    config_path = os.path.join(current_folder,"Isolation", "Visuals.sumocfg")
