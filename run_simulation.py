...
<routes>
    ...
    <vType id="sedan" vClass="passenger" guiShape="passenger/sedan" length="4.5" width="1.8" maxSpeed="22.2" accel="2.6" decel="4.5" color="yellow"/>
    <vType id="hatchback" vClass="passenger" guiShape="passenger/hatchback" length="3.8" width="1.7" maxSpeed="20.0" accel="2.8" decel="4.5" color="cyan"/>
    <vType id="suv" vClass="evehicle" guiShape="passenger/wagon" length="4.8" width="1.9" maxSpeed="25.0" accel="2.5" decel="4.2" color="darkblue"/>
    <vType id="sports_car" vClass="passenger" guiShape="passenger" length="4.2" width="1.9" maxSpeed="33.3" accel="4.0" decel="5.0" color="red"/>
    ...
    <vType id="motorcycle" vClass="motorcycle" guiShape="motorcycle" length="2.2" width="0.9" maxSpeed="25.0" accel="4.5" decel="5.5" color="magenta"/>
    <vType id="scooter" vClass="moped" guiShape="moped" length="1.8" width="0.8" maxSpeed="15.0" accel="3.0" decel="5.0" color="pink"/>
    <vType id="auto_rickshaw" vClass="custom1" guiShape="rickshaw" length="2.7" width="1.3" maxSpeed="12.5" accel="1.8" decel="4.0" color="yellow"/>
    <vType id="e_rickshaw" vClass="custom2" guiShape="rickshaw" length="2.6" width="1.2" maxSpeed="9.0" accel="1.2" decel="3.8" color="lime"/>
    <vType id="bicycle" vClass="bicycle" guiShape="bicycle" length="1.6" width="0.6" maxSpeed="5.5" accel="1.2" decel="3.0" color="teal"/>
    ...
    <vType id="police_car" vClass="authority" guiShape="police" length="4.8" width="1.8" maxSpeed="28.0" accel="3.5" decel="5.0" color="black"/>
    <vType id="tractor" vClass="custom1" guiShape="truck" length="4.0" width="2.0" maxSpeed="8.0" accel="0.8" decel="2.5" color="brown"/>
</routes>
"""
